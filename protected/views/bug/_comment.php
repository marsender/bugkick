...
$form = $this->beginWidget('CActiveForm', array(
	'id' => 'comment-form',
	'action' => Yii::app()->createUrl('comment/create', array(
		'bugId' => $bug->id
	)),
...
<!--		<script type="text/javascript">
		...
		echo $form->hiddenField($model, 'bugId', array(
			'value' => $bug->id
		));
		if ($useWysiwyg == 0) {
			...
			$this->widget('ext.jwysiwyg.EJWisiwyg', array(
				'id' => 'Comment_message',
      ...
      //'redo'=>$visible,
					...
					'events' => array(
						'keyup' => ($useWysiwyg == 0) ? 'js:bugkick.bug.view.onCommentAreaKeyUp' : 'js:function(){
...
/*
	...
	<div class="row buttons">
        <?php
								...
								echo CHtml::ajaxButton(Yii::t('main', 'Post comment'), $this->createUrl('bug/UpdateAjaxComment'), array(
									'type' => 'POST',
...
Yii::app()->clientScript->registerScript('atUsername', '
