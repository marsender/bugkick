<div style="padding: 15px; border: 1px solid #8294BC; box-shadow: 0 0 10px rgba(126,144,186,0.5); width: 680px; margin: 0 auto;" class="round10">
	<div class="form" style="text-align: center; width: 660px; margin: 0 auto;">
		<h2 style="text-align: left; color:#8294BC;"><img alt="Registration with Facebook" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/icons/facebook/facebook_48x48.png" style="margin-right: 7px; vertical-align: bottom;" />Registration with Facebook</h2>
